...
zEulerNonlin = euler(pendulum_nonlin, z0, time)
zHeunNonlin = heun(pendulum_nonlin, z0, time)
...
plt.plot(time, zEulerNonlin[:,0])
plt.plot(time, zHeunNonlin[:,0])
plt.legend(['EulerLin', 'HeunLin', 'EulerNonlin', 'HeunNonlin'], frameon=False, loc='best')
